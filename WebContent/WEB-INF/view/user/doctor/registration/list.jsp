...
<body>
	...
	<table  border="1" bordercolor="#dfdfdf" class="static_table resizable">
	 <thead>
		 ...
		 <th>Specialist</th>
		 <th>Prescription From Doctor</th>
		 <th>Date</th>
		 <th>Action</th>
		 </tr>
	 </thead>
	...
	<td>
		<c:if test="${not empty registration.patient}">
			${registration.patient.username } (click <a href="${baseURL}/user/doctor/registration/medicalHistory/${registration.patient.id}">here</a> for his medical histories)
		</c:if>
	...
	<td><a href="${baseURL}/user/doctor/registration/edit/${registration.id}">edit</a></td>
	</tr>
	</c:forEach>
	 </tbody>
	</table>
