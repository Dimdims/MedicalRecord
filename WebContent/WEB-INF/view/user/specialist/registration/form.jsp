...
<body>
  ...
  <div class="non-shortable-content">
	...
	<div class="shortable-content">
	      <form:form action="${baseURL}/user/specialist/registration/save" modelAttribute="form" method="post">
			    <div class="box-content">
				      ...
				      <div class="form-row">
				       <label for="normal-field"><strong>Laboratory Technician</strong></label>
				       <c:set var="hasError"><form:errors path="laboratoryTechnicianId"/></c:set>
		              	<c:if test="${not empty hasError}">
		              		<c:set var="errorMessage"><form:errors path="laboratoryTechnicianId"/></c:set>
		              		<c:set var="errorMessageType" value="error" />
		              	</c:if>
		              	...
		              	<div class="form-right-col">
		              		...
		              		<form:select path="laboratoryTechnicianId">
							   <form:option value="-1" label="--- Select ---"/>
							   <form:options items="${laboratoryTechnicians}" itemValue="id" itemLabel="username"/>
							</form:select>

							</div>
							<form:errors path="laboratoryTechnicianId" cssClass="error"/>
		              	</div>
		              	<span class="help-inline">${errorMessage}</span>
				      </div>
