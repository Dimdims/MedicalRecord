package com.rekam.medis.web.user.laboratorytechnician;
...
/**
 * 
 * Controller for lab tech home page
 *
 */

@Controller
@RequestMapping(value={"user/laboratoryTechnician"})
public class DashboardLaboratoryTechnicianController {
	...
	public ModelAndView index(HttpServletResponse response,
		...
		return new ModelAndView("user/laboratoryTechnician/dashboardLaboratoryTechnician/index",params);
	}
