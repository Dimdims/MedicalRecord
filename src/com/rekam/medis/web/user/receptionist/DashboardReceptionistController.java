package com.rekam.medis.web.user.receptionist;
...
/**
 * 
 * Controller for receptionist home page
 *
 */

@Controller
@RequestMapping(value={"user/receptionist"})
public class DashboardReceptionistController {
	...
	public ModelAndView index(HttpServletResponse response,
		...
		return new ModelAndView("user/receptionist/dashboardReceptionist/index",params);
	}
