package com.rekam.medis.web.user.specialist;
...
/**
 * 
 * Controller for specialist home page
 *
 */

@Controller
@RequestMapping(value={"user/specialist"})
public class DashboardSpecialistController {
	...
	public ModelAndView index(HttpServletResponse response,
		...
		return new ModelAndView("user/specialist/dashboardSpecialist/index",params);
	}
